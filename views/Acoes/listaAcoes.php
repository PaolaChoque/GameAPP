                ...
                <div id="Layer1" class="col-md-11">
                    <table class="tablesorter" id="Layer1">
                     ...
                     <?php foreach ($acoestable as $acoestable) {     
                      ...
                      <tr class="listas"> 
                        <td style="border-width: thin; border-style: solid; border-color: black;"><?php echo $acoestable['acoes'];?></td>
                        <td style="border-width: thin; border-style: solid; border-color: black;"><center><?php echo $acoestable['vigencia'];?></center></td>
                        <td style="border-width: thin; border-style: solid; border-color: black;"><center><input type="checkbox" name="cep" value="html"checked /> </center></td>
