                ...
                <nav class="navbar navbar-default nab-branco">
                    <div class="container-fluid">
                        ...
                        <div class= 'col-md-5 pull-right'>
                            <a class= "navbar-brand" href ="#"><strong>Ações</strong></a>
                        </div>
                    </div>
                </nav>
            </div>
                    ...
                    <div id="Layer1" class="col-md-11">
                        <table class="tablesorter" id="Layer1">
                            <thead>
                                <tr>
                                    <!-- datatableCount -->
                                    <th style="border-width: thin; border-style: solid; border-color: black;">Ações</th> 
                                    <th style="border-width: thin; border-style: solid; border-color: black;"><center>Vigências </center></th>
                            ...
                            <tbody ng-repeat="membro in membroSede">
                                ...
                                <?php foreach ($acoes as $acao) {
                                    ...
                                    <tr class="listas"> 
                                        <td style="border-width: thin; border-style: solid; border-color: black;"><?php echo $acao['acoes']; ?></td>
                                        <td style="border-width: thin; border-style: solid; border-color: black;"><center><?php echo date('d/m/Y', strtotime($acao['datainicio'])) . ' à ' . date('d/m/Y', strtotime($acao['datatermino'])); ?></center></td>
                                <td style="border-width: thin; border-style: solid; border-color: black;"><center><input type="checkbox" name="cep" class="statusCheckbox" id="<?php echo $acao['id']; ?>" value="<?php echo $acao['status']; ?>" <?php
                                    if ($acao['status'] == 1) {
                                        echo "checked";
                                    }
                                    ?> /> </center></td>
